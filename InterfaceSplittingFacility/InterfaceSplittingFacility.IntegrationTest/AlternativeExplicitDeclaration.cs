...
namespace InterfaceSplittingFacility.IntegrationTest.AlternativeExplicitDeclaration
{
    ...
    public class BasicExplicitDeclaration
    {
        ...
        public void AssertIt()
        {
            ...
            container.Register(
                ...
                Component.For<IBig>().ImplementedAsSplittedInterfaceBy(typeof(ISmall1), typeof(ISmall2), typeof(ISmall3))
                );
